...
import type { CanonicalPlan } from "@jules-halls/contracts";
    ...
    <div className="mx-auto max-w-6xl space-y-8 p-6">
      ...
      <section>
        ...
        <ExecutionPlan
          plan={activePlan}
          onApprovePlan={() => {
            setActivePlan((prev: CanonicalPlan) => ({ ...prev, status: "approved" as const }));
          }}
          onRejectPlan={() => {
            setActivePlan((prev: CanonicalPlan) => ({ ...prev, status: "rejected" as const }));
          }}
        />
      </section>
